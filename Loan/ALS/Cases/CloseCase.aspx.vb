        ...
        If Len(My.Request.QueryString("LoanNo")) > 0 Then
            If Len(My.Request.QueryString("CaseID")) > 0 Then
                ...
                SQL_Codes.RunCommand("INSERT INTO Case_Notes_Entrys (NoteAdded, CaseID, AddedBy, Description) " & _
                                     "VALUES ('" & CurPegTime & "','" & My.Request.QueryString("CaseID") & "','" & Session("User") & "','Closing Case')")
                ...
                SQL_Codes.UpdateData("Case_Status", "CloseTeller", Teller, "CaseNumber", My.Request.QueryString("CaseID"))
                SQL_Codes.UpdateData("Case_Status", "CloseDate", DateValue(CurPegTime), "CaseNumber", My.Request.QueryString("CaseID"))
                SQL_Codes.UpdateData("Case_Status", "Status", "C", "CaseNumber", My.Request.QueryString("CaseID"))
                Dim CaseName As String = SQL_Codes.GetData("Case_Types", "CaseName", "CaseID", SQL_Codes.GetData("Case_Status", "CaseID", "CaseNumber", My.Request.QueryString("CaseID")))
                SQL_Codes.RunCommand("INSERT INTO Notes (LoanID, Priority, Dept, NoteDateTime, Note, EnteredBy) VALUES('" & My.Request.QueryString("LoanNo") & "','N','13','" & Now & "','Case Closed (" & My.Request.QueryString("CaseID") & ") - " & SQL_Codes.GetData("Case_Status", "CaseID", "CaseNumber", My.Request.QueryString("CaseID")) & " | " & CaseName & "','" & Session("User") & "')")
